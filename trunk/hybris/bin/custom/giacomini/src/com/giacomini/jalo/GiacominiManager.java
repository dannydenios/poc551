 ...
 *
 */
package com.giacomini.jalo;

import de.hybris.platform.core.Registry;
import com.giacomini.constants.GiacominiConstants;
...
/**
 * This is the extension manager of the Giacomini extension.
 */
public class GiacominiManager extends GeneratedGiacominiManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(GiacominiManager.class.getName());
	 ...
	 */
	public static GiacominiManager getInstance()
	{
		return (GiacominiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GiacominiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GiacominiManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GiacominiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GiacominiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GiacominiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
