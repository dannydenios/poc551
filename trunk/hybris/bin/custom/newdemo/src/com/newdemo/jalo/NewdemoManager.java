 ...
 *
 */
package com.newdemo.jalo;

import de.hybris.platform.core.Registry;
import com.newdemo.constants.NewdemoConstants;
...
/**
 * This is the extension manager of the Newdemo extension.
 */
public class NewdemoManager extends GeneratedNewdemoManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(NewdemoManager.class.getName());
	 ...
	 */
	public static NewdemoManager getInstance()
	{
		return (NewdemoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NewdemoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NewdemoManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NewdemoManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NewdemoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NewdemoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
